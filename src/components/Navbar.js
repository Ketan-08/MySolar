                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 text-center">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link dropdown" to="/calculator">Solar Calculator</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link dropdown" to="/contact">Contact Us</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link dropdown" to="/training">Training</Link>
                            </li>
