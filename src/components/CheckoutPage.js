...
function CheckoutPage(props) {
    ...
    const checkoutContext = useContext(myContext);
    ...
    const payNow = () => {
        ...
        let amount = (checkoutContext.finalPrice - checkoutContext.finalPrice * 0.1).toString();
        ...
        fetch('http://127.0.0.1:8000/api/payment/', requestOptions)
            ...
            .then(data => checkoutContext.dispData(JSON.stringify(data)))

        setTimeout(() => {
            window.location.href = "http://localhost:3000/order_details";
        }, 30000);
            ...
            <div id='mainContainer'>
                ...
                <div id='summary'>
                    ...
                    <div id='checkoutPrice' className='shadow-sm'>
                        ...
                        <hr />
                        <p id='priceBox'>
                            <span>Price :  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  ₹ {checkoutContext.finalPrice} </span><br />
                            <span>Discount :  &nbsp; &nbsp; &nbsp; ₹ {checkoutContext.finalPrice * 0.1}</span> <br />
                            <span>Delivery Charges :  FREE</span> <br />
                            <hr />
                            <span>Total Amount : &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ₹  {checkoutContext.finalPrice -
                                checkoutContext.finalPrice * 0.1}</span>

                        </p>

                    </div>
                    <button id='payNow-btn' onsubmit="return false" onClick={payNow}><header><i class="fa fa-credit-card"></i>&nbsp; PAY NOW</header></button>
