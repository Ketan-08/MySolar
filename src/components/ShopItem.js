...
function ShopItem(props) {
  ...
  return (
    ...
    <div className='my-3 shadow fullCard'> 
       ...
       <img src={props.img} alt='solar item' className='mx-3' style={{width:'14.3rem',height:'14.3rem',float:'left'}}/>
      ...
      Working Voltage : {props.details.working_voltage}
       ...
       <Button variant="contained" id='buyBtn'>Add to Cart &rarr;</Button>
        ...
        <Button  id='subBtn' variant="outlined" size="large" className='mx-2' onClick={SubQuantity}>-</Button>
         {quantity}
        <Button  id='addBtn'variant="outlined" size="large" className='mx-2' onClick={AddQuantity}>+</Button>
